...
static HASH: &str = "$argon2id$v=19$m=4096,t=192,p=4$o2y5PU86Vt+sr93N7YUGgC7AMpTKpTQCk4tNGUPZMY4$yzP/\
                     ukZRPIbZg6PvgnUUobUMbApfF9RH6NagL9L4Xr4";
static SECRET_KEY: &str =
   "secret key that you should really store in a .env file instead of in code, but this is just an example";
