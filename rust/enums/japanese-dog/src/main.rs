...
impl From<u32> for JapaneseDogBreeds
{
   fn from(other: u32) -> Self
   {
      match other
      {
         ...
         other if JapaneseDogBreeds::KaiKen as u32 == other => JapaneseDogBreeds::KaiKen,
         other if JapaneseDogBreeds::KishuInu as u32 == other => JapaneseDogBreeds::KishuInu,
         other if JapaneseDogBreeds::ShibaInu as u32 == other => JapaneseDogBreeds::ShibaInu,
         other if JapaneseDogBreeds::ShikokuKen as u32 == other => JapaneseDogBreeds::ShikokuKen,
