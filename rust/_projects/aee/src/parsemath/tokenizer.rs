/// This module reads characters in arithmetic expression and converts them to
/// tokens. The allowed tokens are defined in ast module.
// Standard lib
...
// With this, we can use next() method on tokenizer to retrieve the next token
